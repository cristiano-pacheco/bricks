...
func (_m *MockOption) Execute(_a0 *chi.Config) {
	_m.Called(_a0)
}
...
func (_c *MockOption_Execute_Call) Run(run func(_a0 *chi.Config)) *MockOption_Execute_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*chi.Config))
	})
	return _c
}
...
func (_c *MockOption_Execute_Call) RunAndReturn(run func(*chi.Config)) *MockOption_Execute_Call {
	_c.Run(run)
	return _c
}
